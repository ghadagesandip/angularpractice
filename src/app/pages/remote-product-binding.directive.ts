...
import { ProductsService } from './products/northwind.service';
import { Subscription } from 'rxjs';

@Directive({
    selector: '[productsBinding]'
})
export class RemoteProductBindingDirective extends DataBindingDirective implements OnInit, OnDestroy {
